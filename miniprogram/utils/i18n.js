...
const strings = {
  en: {
    ...
    event_cost_to_join: 'Cost to Join',
    event_activity_details: 'Activity Details',
    event_remaining_slots: 'Remaining',
    event_status: 'Status',
    ...
    event_profile_incomplete: 'Please complete your profile (name, gender) before signing up',
    ...
    profile_ntrp: 'Skill Level (NTRP)',
    profile_dltr: 'DLTR Rating',
    profile_unrated: 'Unrated',
    ...
    admin_event_cost: 'Cost to Join',
    admin_event_details: 'Activity Details',
    ...
    admin_min_players_hint_singles: 'Minimum 2 players required',
    admin_event_type: 'Event Type',
    admin_event_type_singles: 'Singles',
    admin_event_type_doubles: 'Doubles',
    ...
    admin_confirm_delete_event: 'Are you sure you want to delete this event? All signups, matchups, and results will be permanently deleted.',
  ...
  zh: {
    ...
    event_time: '时间',
    event_location: '地点',
    event_cost_to_join: '参与费用',
    event_activity_details: '活动详情',
    event_remaining_slots: '仅剩',
    event_status: '状态',
    ...
    event_profile_incomplete: '报名前请先完善个人资料（姓名、性别）',
    ...
    admin_event_cost: '参与费用',
    admin_event_details: '活动详情',
    ...
    admin_min_players_hint_singles: '至少需要2名球员',
    admin_event_type: '活动类型',
    admin_event_type_singles: '单打',
    admin_event_type_doubles: '双打',
    ...
    admin_delete_event: '删除活动',
    admin_confirm_delete_event: '确定要删除此活动吗？所有报名、对阵和比赛结果将被永久删除。',
