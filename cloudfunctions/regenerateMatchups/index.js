// ABOUTME: Regenerates match pairings for an event, replacing any existing matchups.
// ABOUTME: Uses the same logic as generateMatchups but also removes approved/published matches.
...
exports.main = async (event, context) => {
  ...
  await db.collection('matches')
    .where({ eventId, status: _.in(['draft', 'needs_admin', 'approved', 'published']) })
    .remove();
